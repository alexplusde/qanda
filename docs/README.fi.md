...
| Tyyppi   | Typname | Nimi   | Bezeichnung |
| -------- | ------- | ------ | ----------- |
| value    | text    | name   | Otsikko     |
| validate | unique  | name   |             |
| validate | empty   | name   |             |
| value    | choice  | status | Tila        |
